...
## 八、OpenClaw 产品化知识库层 / 索引层 / 备份层结构
- 飞书知识库 / 云文档：正文层，承载 OpenClaw 产品化长内容
- 飞书多维表格 `OpenClaw产品迭代`：索引层，承载知识库链接、GitHub 文档链接、状态、阶段、下一步
- GitHub：备份层，承载镜像、规则、说明、留痕与同步口径

### 同步顺序
1. 先更新 GitHub 主文档或冻结新的产品化结论
2. 再回填飞书知识库正文层
